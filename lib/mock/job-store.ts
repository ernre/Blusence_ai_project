  ...
  return {
    ...
    providers: [
      ...
      },
      {
        ...
        status: "hosted",
        requires: ["IDM_VTON_NON_COMMERCIAL_ACK=true", "HF_TOKEN recommended for ZeroGPU quota"],
        notes: "Hosted research baseline kept separate from proprietary VPE ownership.",
        active: false,
      },
    ],
  };
